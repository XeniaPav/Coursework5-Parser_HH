...
def main_func(dbname, params):
    ...
    """
    user_input = int(input("""Привет! Загрузили для тебя информацию по полседним новеньких работодателям на HH!
    ...
    if user_input == 1:
        ...
        print("Список всех вакансий, у которых зарплата выше средней по всем вакансиям. Компания, должность, зарплата от, зарплата до, ссылка на вакансию(учитывается только зарплата в рублях):")
