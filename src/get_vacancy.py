...
def get_company():
    ...
    for i in range(0, 100):
        if len(list_company) == 15:
            break
        elif {"id": vacancies_hh['items'][i]["employer"]['id'], 'name': vacancies_hh['items'][i]["employer"]['name'], 'url': vacancies_hh['items'][i]["employer"]['url']} in list_company:
            continue
        else:
            list_company.append({"id": vacancies_hh['items'][i]["employer"]['id'], 'name': vacancies_hh['items'][i]["employer"]['name'], 'url': vacancies_hh['items'][i]["employer"]['url']})
    return list_company
